...
const DEFAULT_ALPHA_SEED_GAIN = 1.08;
const VIDEO_ALPHA_PROFILE = '96-20260520';
const VIDEO_ALPHA_EDGE_BOOST = 0.055;
const VIDEO_INSET_ALPHA_EDGE_BOOST = 0.045;
...
export function detectDiamondVideoWatermarkFromFrames({
    ...
    if (!candidates.length) {
        throw new Error(`Currently unsupported video watermark candidate for ${width}x${height}`);
    }
